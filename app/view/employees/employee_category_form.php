...
if ($isEditing = isset($_SESSION['category_id'])) {
    $isEditing = false;
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/hardwareTracker/css/employee/employee_category_form.css">
    <style>
        ...
        <div class="form-card">
            <form action="/hardwareTracker/employees" method="post">
                ...
                <div class="text-center">
                    <button type="submit" class="btn-submit" name="operation" value="addEmployeeCategory">
