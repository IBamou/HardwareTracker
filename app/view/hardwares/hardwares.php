...
<head>
    ...
    <link rel="stylesheet" href="app/css/hardware/hardwares.css">
    <style>
                @import url('https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600&display=swap');

        body {
            background: #f8f5f0; /* Warm cream background */
            min-height: 100vh;
        ...
        .page-title i {
            color: #8b4513; /* Warm saddle brown */
            font-size: 1.8rem;
        }
        ...
        .category-card:hover {
            ...
            border-left-color: #8b4513; /* Brown accent on hover */
        }
        ...
        .btn-show:hover {
            background: #654321; /* Darker brown */
...
.btn-delete {
    ...
    height: 36px;
        ...
        .btn-delete:hover {
            background: #b8860b; /* Darker chocolate */
            transform: scale(1.03);
        }

        /* Fixed add buttons container */
        .fixed-add-buttons {
            position: fixed;
            bottom: 2rem;
            right: 2rem;
        ...
        .btn-fixed-add {
            background: #ffd700; /* Yellow to match nav active links */
            color: #333;
            border: none;
            border-radius: 10px;
            padding: 1rem 1.5rem;
